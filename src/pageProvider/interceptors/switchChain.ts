...
export const switchChainNotice = (
  ...
  const rawContent = `<img style="width: 20px; margin-right: 8px;" src="${Iconunhosted}"/>Switched to <span class="unhosted-strong" style="margin: 0 8px;">${chain?.name}</span> for the current Dapp`;
